        ...
        <div class="form-row">
            <div class="form-col">
                <div class="form-group">
                    ...
                    <asp:RangeValidator runat="server" ControlToValidate="txtMonto" MinimumValue="0" MaximumValue="9999999" Type="Double" ErrorMessage="Monto invalido." ForeColor="Red" Display="Dynamic" Font-Size="12px" />
                </div>
            </div>
            <div class="form-col">
                <div class="form-group">
